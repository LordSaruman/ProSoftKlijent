 ...
 * @author ifpr85
 */
public class UnosDostignuca extends javax.swing.JDialog {

    Tim tim;
    /**
     * Creates new form UnosDostignuca
     */
    public UnosDostignuca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("[CSGO] Entering accomplishments for a Team");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UnosDostignuca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UnosDostignuca dialog = new UnosDostignuca(new javax.swing.JFrame(), true);
